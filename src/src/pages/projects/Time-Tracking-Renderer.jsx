...
export default class TimeTrackingRenderer extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Time-Tracking-Renderer"];
        ...
        let projectName = "Time-Tracking-Renderer";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Time-Tracking-Renderer"}/page.html`;
        ...
        projectImage.id = `${"Time-Tracking-Renderer"}-image`;
        ...
        this.projectsGalleryStates["Time-Tracking-Renderer"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Time-Tracking-Renderer">
                <Navbar />
                <Background />
