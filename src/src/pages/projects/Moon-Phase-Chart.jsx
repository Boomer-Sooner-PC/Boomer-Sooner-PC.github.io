...
export default class MoonPhaseChart extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Moon-Phase-Chart"];
        ...
        let projectName = "Moon-Phase-Chart";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Moon-Phase-Chart"}/page.html`;
        ...
        projectImage.id = `${"Moon-Phase-Chart"}-image`;
        ...
        this.projectsGalleryStates["Moon-Phase-Chart"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Moon-Phase-Chart">
                <Navbar />
                <Background />
