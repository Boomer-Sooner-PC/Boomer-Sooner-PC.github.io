...
export default class EducatorsExchangeRISDxACMHackathon extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Educators-Exchange--RISDxACM-Hackathon"];
        ...
        let projectName = "Educators-Exchange--RISDxACM-Hackathon";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Educators-Exchange--RISDxACM-Hackathon"}/page.html`;
        ...
        projectImage.id = `${"Educators-Exchange--RISDxACM-Hackathon"}-image`;
        ...
        this.projectsGalleryStates["Educators-Exchange--RISDxACM-Hackathon"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Educators-Exchange--RISDxACM-Hackathon">
                <Navbar />
                <Background />
