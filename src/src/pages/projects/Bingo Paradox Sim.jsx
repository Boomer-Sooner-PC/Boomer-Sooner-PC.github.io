...
export default class Bingo Paradox Sim extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Bingo Paradox Sim"];
        ...
        let projectName = "Bingo Paradox Sim";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Bingo Paradox Sim"}/page.html`;
        ...
        projectImage.id = `${"Bingo Paradox Sim"}-image`;
        ...
        this.projectsGalleryStates["Bingo Paradox Sim"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Bingo Paradox Sim">
                <Navbar />
                <Background />
