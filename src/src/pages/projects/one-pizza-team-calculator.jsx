...
export default class onepizzateamcalculator extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["one-pizza-team-calculator"];
        ...
        let projectName = "one-pizza-team-calculator";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"one-pizza-team-calculator"}/page.html`;
        ...
        projectImage.id = `${"one-pizza-team-calculator"}-image`;
        ...
        this.projectsGalleryStates["one-pizza-team-calculator"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="one-pizza-team-calculator">
                <Navbar />
                <Background />
