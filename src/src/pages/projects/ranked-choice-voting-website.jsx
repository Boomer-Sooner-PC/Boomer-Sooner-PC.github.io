...
export default class rankedchoicevotingwebsite extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["ranked-choice-voting-website"];
        ...
        let projectName = "ranked-choice-voting-website";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"ranked-choice-voting-website"}/page.html`;
        ...
        projectImage.id = `${"ranked-choice-voting-website"}-image`;
        ...
        this.projectsGalleryStates["ranked-choice-voting-website"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="ranked-choice-voting-website">
                <Navbar />
                <Background />
