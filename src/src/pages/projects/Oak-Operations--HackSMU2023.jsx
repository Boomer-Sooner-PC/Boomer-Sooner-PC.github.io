...
export default class OakOperationsHackSMU2023 extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Oak-Operations--HackSMU2023"];
        ...
        let projectName = "Oak-Operations--HackSMU2023";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Oak-Operations--HackSMU2023"}/page.html`;
        ...
        projectImage.id = `${"Oak-Operations--HackSMU2023"}-image`;
        ...
        this.projectsGalleryStates["Oak-Operations--HackSMU2023"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Oak-Operations--HackSMU2023">
                <Navbar />
                <Background />
