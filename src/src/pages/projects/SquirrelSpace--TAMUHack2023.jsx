...
export default class SquirrelSpaceTAMUHack2023 extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["SquirrelSpace--TAMUHack2023"];
        ...
        let projectName = "SquirrelSpace--TAMUHack2023";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"SquirrelSpace--TAMUHack2023"}/page.html`;
        ...
        projectImage.id = `${"SquirrelSpace--TAMUHack2023"}-image`;
        ...
        this.projectsGalleryStates["SquirrelSpace--TAMUHack2023"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="SquirrelSpace--TAMUHack2023">
                <Navbar />
                <Background />
