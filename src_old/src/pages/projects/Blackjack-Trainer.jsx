...
export default class BlackjackTrainer extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const project = projectsData["Blackjack-Trainer"];
        ...
        let projectName = "Blackjack-Trainer";
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"Blackjack-Trainer"}/page.html`;
        ...
        projectImage.id = `${"Blackjack-Trainer"}-image`;
        ...
        this.projectsGalleryStates["Blackjack-Trainer"] = {
            index: 0,
    ...
    render() {
        return (
            <div className="Blackjack-Trainer">
                <Navbar />
                <Background />
