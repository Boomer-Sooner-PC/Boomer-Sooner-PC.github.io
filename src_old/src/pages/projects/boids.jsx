...
Quick and simple boids simulation following the 3 rules to describe boid behavior.
`;
...
export default class boids extends React.Component {
    ...
    componentDidMount() {
        const project = projectsData["boids"];
        ...
        if (project.build) {
            ...
            projectLink.href = `/builds/${"boids"}/page.html`;
        ...
        this.projectsGalleryStates["boids"] = {
            index: 0,
